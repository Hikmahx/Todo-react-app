...
const TodoItem = ({checkBox, todo, error, errMessage, deleteTodo, updateTodo, dragItem}) => {  
  if(!error){
    return (
      <li data-completed={todo.completed} data-id={todo.id} onDragStart={dragItem} draggable='true' className="todo-item relative flex items-center h-12 lg:h-16 px-5 lg:px-6 w-full border-b border-light-grayish-blue dark:border-dark-grayish-blue-dark">
