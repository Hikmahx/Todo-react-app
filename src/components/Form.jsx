...
const Form = () => {
  ...
  return (
    <div style={{maxWidth:"34rem", top:"0.1rem"}} className="form-wrapper -mt-24 md:-mt-28 lg:-mt-36 relative mx-6 md:mx-auto h-12 lg:h-16 bg-white dark:bg-very-dark-desaturated-blue transition-colors rounded flex items-center">
