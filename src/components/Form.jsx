...
const Form = () => {
  ...
  return (
    <div className="mx-6">
    <div style={{maxWidth:"34rem", top:"0.1rem"}} className="form-wrapper -mt-24 xl:-mt-36 relative mx-auto h-12 lg:h-16 bg-white dark:bg-very-dark-desaturated-blue transition-colors rounded flex items-center">
