  ...
  return (
    <header className="w-full relative flex justify-center">
      <div className="header-background">
        <img src={bgMobileLight} alt="header-img" className="absolute inset-0 object-cover w-full lg:hidden" />
        <img src={bgDesktopLight} alt="header-img" className="absolute inset-0 object-cover w-full hidden lg:block" />
        <div className="screen  bg-gradient-to-r from-gradient-blue to-gradient-purple absolute inset-0 opacity-50"></div>
      </div>
